...
//   const fallbackPic = "../src/assets/photo.png";
//   return (
...
import SectionWrapper from "./SectionWrapper";
import profilePic from "../assets/my-image.png";
import fallbackPic from "../assets/photo.png";
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <div className="space-y-4 text-foreground/70 text-lg leading-relaxed">
            ...
            <p>
              I'm currently working as a Web Developer Intern, where I'm learning how to build professional apps and collaborate in team environments. My goal is to keep growing as a developer and contribute to impactful projects.
            </p>
